...
# ======================================================================
@ 029__mechanism_of_reset_and_checkout

# In empty new directory, run
git init
...
# ======================================================================
git log
/home/young/Pictures/2019_02_25_17:32:46.png

Suppose you want to go back to "commit 3"
and you want to cancel (or delete) "commit 4"

# ======================================================================
Copy commit ID of "commit 3"

git reset --hard commit_3_id

git log
/home/young/Pictures/2019_02_25_17:34:47.png

# ======================================================================
/home/young/Pictures/2019_02_25_17:35:14.png

refs/heads/master file contains contents 
which point to latest commit in master branch in which you're in

/home/young/Pictures/2019_02_25_17:36:29.png

# ======================================================================
Workflow

Git opens ./.git/HEAD file

Git opens refs/heads/master file

Git knows latest commit

# ======================================================================
Reset is the act of change point refernce to the commit

# ======================================================================
Where is "commit 4"?

Git generally doesn't delete files except for very special cases 
where garbage collector runs on too many files,
which happnes rarely.

# ======================================================================
What if you cancel "reset"?

Let's see ./.git/ORIG_HEAD file
/home/young/Pictures/2019_02_25_17:40:10.png

It has "commit 4"

./.git/ORIG_HEAD file writes latest commit in current branch
before performing dangerous command

# ======================================================================
Let's see ./.git/logs/refs/heads/master file

/home/young/Pictures/2019_02_25_17:41:23.png

./.git/logs/refs/heads/master file writes various actions happened in master branch

# ======================================================================
# You can cancel "reset"
git reset --hard ORIG_HEAD

git log
/home/young/Pictures/2019_02_25_17:44:39.png

# ======================================================================
Better way than using ORIG_HEAD is to see logs/refs/heads/master
where more and various data are written

# To use logs/refs/heads/master file
git reflog
/home/young/Pictures/2019_02_25_17:45:52.png

# ======================================================================
git checkout commit_id
/home/young/Pictures/2019_02_25_17:47:17.png

git branch
/home/young/Pictures/2019_02_25_17:47:41.png

git log
/home/young/Pictures/2019_02_25_17:48:07.png

# ======================================================================
If you see gistory, changed file is HEAD file
/home/young/Pictures/2019_02_25_17:48:27.png

Previously, HEAD file pointed to refs/heads/master file
current HEAD file points to commit id
/home/young/Pictures/2019_02_25_17:49:47.png

Your HEAD points to commit than branch
This status is "detached"
...
# ======================================================================
@ 지옥에서 온 Git - ssh를 이용해서 로그인없이 원격저장소 사용하기 (Github)
# ======================================================================
clone 할때 https 주소를 사용하면 복잡한 설정없이 ip, password 를 입력해서 remote repository 에 push 할 수 있다
간편한 대신 push or connect to remote repository 할 때마다 id, password 를 입력해야했다

# ======================================================================
Secure Shell 은 자동 로그인 수단은 아니다
http 같은 통신 protocol 종류이다
ssh 는 자동으로 login 해주는 기능을 제공하는 것이다

# ======================================================================
ssh-keygen 을 실행한다
directory 를 note 한다
계속 enter 를 누르면 ssh 를 통해서 다른 computer 로 접속 할 수 있는 일종의 password 가 생성된다
hash function 을 이용해서 복잡한 password 가 생성된것이다
password 는 위에서 note 한 directory 에 id_rsa, id_rsa.pub 파일로 저장되었다

# ======================================================================
id_rsa 는 private key 이다. my local computer 에 저장해 놓는다
id_rsa.pub 은 public key 이다. server 에 저장해 놓는다

# ======================================================================
github 에 public key 저장하는 방법

# ======================================================================
cat id_rsa.pub 을 실행해 key 를 copy 한다
github 에서 settting 가서 ssh and gpg keys 에 들어간다
title 에는 local repository 의 name 을 적는다
key 에 copied public key 를 paste 한다

# ======================================================================
ssh address 를 copy 한다
local repository 없을때 github instruction commands 를 따른다
or 다음과 같이 한다

git clone ssh-address

# ======================================================================
@ 지옥에서 온 Git - 원격 저장소의 원리
...
config file 이 modified 되었다
여기에 remote repository 정보가 들어있다
fetch 는 정보를 가져올 때 remote repository 의 어디에서 local repository 어디로 정보를 가져올 것인가 와 같은 정보이다
...
upstream : local repository 에 연결되어있는 remote repository 라고 생각하면 된다

# ======================================================================
git push --set-upstream origin master 을하면 두가지 일이 발생한다

1. local repository 의 master branch 를 remote repository 의 master branch 로 연결시킨다
1. code 들을 upload 한다

# ======================================================================
config file 이 수정되었다
remote repository 에 관한 사항이다
branch "master" : local repository 의 branch 를 의미한다
remote = origin
merge=refs/heads/master

# ======================================================================
refs/remotes/origin/master 를 보자
link 를 click 하면 origin 으로 push 한 user 의 정보가 적혀있다

# ======================================================================
refs/heads/master 는 local repository 의 master branch 에 관한 정보를 담고있다

# ======================================================================
@ 지옥에서 온 Git - pull VS fetch의 원리

# ======================================================================
remote repository 에서 local repository 로 code 를 가져올때 2가지 방법이 있다

# ======================================================================
git pull, git fetch 이다

# ======================================================================
보통은 pull 을 쓰는데 정교함을 위해서 fetch 를 쓸때가 있다

# ======================================================================
pull 을 하면 다음과 같다

# ======================================================================
object link, 이름, 클릭하면 파일의 내용, 변경된 사항을 표시하는 commit history 가 다운로드 되었다
또한 refs/heads/master 를 보면 local repository 의 master branch 가 어떤 commit 을 가리키는가 를 적어놓은 file 이 바뀌었다
refs/remotes/origin/master 를 보면 remote repository 에서 master branch 의 commit 이 무엇을 가르키는지 보여준다
결론적으로, local branch 와 remote branch 가 똑같은 commit 을 가리키고 있다

# ======================================================================
ORIG_HEAD 은 이전 commit 을 가리킨다
git pull 을 했는데 잘못 merge 된 case 라면 ORIG_HEAD 에 적혀있는 정보를 통해서 merge 이전의 상태로 돌릴수 있다

# ======================================================================
git fetch
git log --decorate --all --oneline

local repository 의 master branch 는 아까와 똑같은 6 을 가리키고 있다

remote repository 의 master branch 는 office local repository 에서 push 한 7 을 가리키고 있다

즉, origin master 가 local master 를 앞서고 있는 상황이다

# ======================================================================
즉, remote 에서 다운로드를 받는다
다운받은 commit 이 remote 에서 몇번인지도 받았다
하지만, local 의 master 에는 변화를 가하지 않았다
이것이 fetch 이동한다

# ======================================================================
좋은점 : remote 에서 가져오고 merge 는 안한다
그래서 local 과 remote 의 차이점을 비교할 수 있다
그런다음 git merge origin/master 를 해서 local 의 master 로 merge 한다
